...
/* 用户存储操作接口 */
SPECTRAARSENAL_API int SA_WriteUserMemory(int spectrometerIndex, int Address, int length, unsigned char * UserData);
SPECTRAARSENAL_API int SA_ReadUserMemory(int spectrometerIndex, int Address, int length, unsigned char * UserData);
